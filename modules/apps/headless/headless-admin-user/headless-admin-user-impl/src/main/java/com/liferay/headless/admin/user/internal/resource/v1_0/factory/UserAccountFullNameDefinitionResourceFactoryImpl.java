 ...
 */
@Component(
	property = "resource.locator.key=/headless-admin-user/v1.0/UserAccountFullNameDefinition",
	service = UserAccountFullNameDefinitionResource.Factory.class
)
@Generated("")
public class UserAccountFullNameDefinitionResourceFactoryImpl
	implements UserAccountFullNameDefinitionResource.Factory {

	@Override
	public UserAccountFullNameDefinitionResource.Builder create() {
		return new UserAccountFullNameDefinitionResource.Builder() {
			...
			public UserAccountFullNameDefinitionResource build() {
				...
				Function
					<InvocationHandler, UserAccountFullNameDefinitionResource>
						userAccountFullNameDefinitionResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_userAccountFullNameDefinitionResourceProxyProviderFunction;

				return userAccountFullNameDefinitionResourceProxyProviderFunction.
					apply(
			...
			@Override
			public UserAccountFullNameDefinitionResource.Builder
			...
			@Override
			public UserAccountFullNameDefinitionResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public UserAccountFullNameDefinitionResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			UserAccountFullNameDefinitionResource.class.getClassLoader(),
			UserAccountFullNameDefinitionResource.class);

		try {
			Constructor<UserAccountFullNameDefinitionResource> constructor =
				(Constructor<UserAccountFullNameDefinitionResource>)
