 ...
 */
@Component(
	property = "resource.locator.key=/change-tracking-rest/v1.0/CTProcess",
	service = CTProcessResource.Factory.class
)
@Generated("")
public class CTProcessResourceFactoryImpl implements CTProcessResource.Factory {

	@Override
	public CTProcessResource.Builder create() {
		return new CTProcessResource.Builder() {
			...
			@Override
			public CTProcessResource.Builder checkPermissions(
			...
			@Override
			public CTProcessResource.Builder httpServletRequest(
			...
			@Override
			public CTProcessResource.Builder httpServletResponse(
			...
			@Override
			public CTProcessResource.Builder preferredLocale(
			...
			@Override
			public CTProcessResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public CTProcessResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, CTProcessResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CTProcessResource.class.getClassLoader(), CTProcessResource.class);

		try {
			Constructor<CTProcessResource> constructor =
				(Constructor<CTProcessResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(ctProcessResource);
	...
	private ComponentServiceObjects<CTProcessResource> _componentServiceObjects;
