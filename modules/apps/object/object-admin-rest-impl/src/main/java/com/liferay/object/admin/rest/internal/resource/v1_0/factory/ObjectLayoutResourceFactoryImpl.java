	...
	public ObjectLayoutResource.Builder create() {
		return new ObjectLayoutResource.Builder() {
			...
			public ObjectLayoutResource build() {
				...
				Function<InvocationHandler, ObjectLayoutResource>
					objectLayoutResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_objectLayoutResourceProxyProviderFunction;

				return objectLayoutResourceProxyProviderFunction.apply(
			...
			@Override
			public ObjectLayoutResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
