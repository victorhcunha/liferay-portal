 ...
 */
@Generated("")
@GraphQLName("DuplicateObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DuplicateObjectBulkSelectionAction")
public class DuplicateObjectBulkSelectionAction
	...
	public static DuplicateObjectBulkSelectionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DuplicateObjectBulkSelectionAction.class, json);
	}

	public static DuplicateObjectBulkSelectionAction unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.DuplicateObjectBulkSelectionAction",
		name = "x-class-name"
	)
