...
public class UserSessions implements Serializable {
	...
	public static UserSessions toDTO(String json) {
		return ObjectMapperUtil.readValue(UserSessions.class, json);
	}

	public static UserSessions unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(UserSessions.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.UserSessions",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-2137397281