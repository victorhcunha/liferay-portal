 ...
 */
@Component(
	property = "resource.locator.key=/export-import/v1.0/ImportProcess",
	service = ImportProcessResource.Factory.class
)
@Generated("")
public class ImportProcessResourceFactoryImpl
	...
	public ImportProcessResource.Builder create() {
		return new ImportProcessResource.Builder() {
			...
			public ImportProcessResource build() {
				...
				Function<InvocationHandler, ImportProcessResource>
					importProcessResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_importProcessResourceProxyProviderFunction;

				return importProcessResourceProxyProviderFunction.apply(
			...
			@Override
			public ImportProcessResource.Builder checkPermissions(
			...
			@Override
			public ImportProcessResource.Builder httpServletRequest(
			...
			@Override
			public ImportProcessResource.Builder httpServletResponse(
			...
			@Override
			public ImportProcessResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, ImportProcessResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ImportProcessResource.class.getClassLoader(),
			ImportProcessResource.class);

		try {
			Constructor<ImportProcessResource> constructor =
				(Constructor<ImportProcessResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(importProcessResource);
	...
	private ComponentServiceObjects<ImportProcessResource>
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, ImportProcessResource>
			_importProcessResourceProxyProviderFunction =
				_getProxyProviderFunction();
