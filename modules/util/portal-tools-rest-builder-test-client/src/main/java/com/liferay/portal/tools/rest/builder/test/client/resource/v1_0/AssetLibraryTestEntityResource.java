 ...
 */
@Generated("")
public interface AssetLibraryTestEntityResource {
	...
	public Page<AssetLibraryTestEntity>
			getAssetLibraryAssetLibraryTestEntitiesPage(Long assetLibraryId)
		throws Exception;

	public HttpInvoker.HttpResponse
			getAssetLibraryAssetLibraryTestEntitiesPageHttpResponse(
				Long assetLibraryId)
		throws Exception;

	public void postAssetLibraryAssetLibraryTestEntitiesPageExportBatch(
			Long assetLibraryId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postAssetLibraryAssetLibraryTestEntitiesPageExportBatchHttpResponse(
				Long assetLibraryId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class Builder {
		...
		public AssetLibraryTestEntityResource build() {
			return new AssetLibraryTestEntityResourceImpl(this);
		}
	...
	public static class AssetLibraryTestEntityResourceImpl
		implements AssetLibraryTestEntityResource {
		...
		public Page<AssetLibraryTestEntity>
			...
			try {
				return Page.of(content, AssetLibraryTestEntitySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private AssetLibraryTestEntityResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AssetLibraryTestEntityResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1206079981