 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductConfigurationListOrderType",
	service = ProductConfigurationListOrderTypeResource.Factory.class
)
@Generated("")
public class ProductConfigurationListOrderTypeResourceFactoryImpl
	implements ProductConfigurationListOrderTypeResource.Factory {

	@Override
	public ProductConfigurationListOrderTypeResource.Builder create() {
		return new ProductConfigurationListOrderTypeResource.Builder() {
				...
				Function
					<InvocationHandler,
					 ProductConfigurationListOrderTypeResource>
						productConfigurationListOrderTypeResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_productConfigurationListOrderTypeResourceProxyProviderFunction;

				return productConfigurationListOrderTypeResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductConfigurationListOrderTypeResource.Builder
			...
			@Override
			public ProductConfigurationListOrderTypeResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ProductConfigurationListOrderTypeResource.Builder user(
				User user) {
	...
	private static Function
		<InvocationHandler, ProductConfigurationListOrderTypeResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductConfigurationListOrderTypeResource.class.getClassLoader(),
			ProductConfigurationListOrderTypeResource.class);

		try {
			Constructor<ProductConfigurationListOrderTypeResource> constructor =
				(Constructor<ProductConfigurationListOrderTypeResource>)
