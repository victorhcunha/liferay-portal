...
package com.liferay.headless.user.notification.internal.resource.v1_0.factory;

import com.liferay.headless.user.notification.internal.security.permission.LiberalPermissionChecker;
 ...
 */
@Component(
	property = "resource.locator.key=/headless-user-notification/v1.0/UserNotification",
	service = UserNotificationResource.Factory.class
)
@Generated("")
public class UserNotificationResourceFactoryImpl
	...
	public UserNotificationResource.Builder create() {
		return new UserNotificationResource.Builder() {
			...
			@Override
			public UserNotificationResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
