 ...
 */
@Component(
	property = "resource.locator.key=/test/v1.0/AssetLibraryTestEntity",
	service = AssetLibraryTestEntityResource.Factory.class
)
@Generated("")
public class AssetLibraryTestEntityResourceFactoryImpl
	implements AssetLibraryTestEntityResource.Factory {

	@Override
	public AssetLibraryTestEntityResource.Builder create() {
		return new AssetLibraryTestEntityResource.Builder() {

			@Override
			public AssetLibraryTestEntityResource build() {
				if (_user == null) {
					throw new IllegalArgumentException("User is not set");
				}

				Function<InvocationHandler, AssetLibraryTestEntityResource>
					assetLibraryTestEntityResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_assetLibraryTestEntityResourceProxyProviderFunction;

				return assetLibraryTestEntityResourceProxyProviderFunction.
					apply(
			...
			@Override
			public AssetLibraryTestEntityResource.Builder checkPermissions(
			...
			@Override
			public AssetLibraryTestEntityResource.Builder httpServletRequest(
			...
			@Override
			public AssetLibraryTestEntityResource.Builder httpServletResponse(
			...
			@Override
			public AssetLibraryTestEntityResource.Builder preferredLocale(
			...
			@Override
			public AssetLibraryTestEntityResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public AssetLibraryTestEntityResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, AssetLibraryTestEntityResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AssetLibraryTestEntityResource.class.getClassLoader(),
			AssetLibraryTestEntityResource.class);

		try {
			Constructor<AssetLibraryTestEntityResource> constructor =
				(Constructor<AssetLibraryTestEntityResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, AssetLibraryTestEntityResource>
				_assetLibraryTestEntityResourceProxyProviderFunction =
					_getProxyProviderFunction();
...
// LIFERAY-REST-BUILDER-HASH:-1486521182