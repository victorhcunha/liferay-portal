	...
	public SiteScopeResource.Builder create() {
		return new SiteScopeResource.Builder() {
			...
			public SiteScopeResource build() {
				...
				Function<InvocationHandler, SiteScopeResource>
					siteScopeResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_siteScopeResourceProxyProviderFunction;

				return siteScopeResourceProxyProviderFunction.apply(
			...
			@Override
			public SiteScopeResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
