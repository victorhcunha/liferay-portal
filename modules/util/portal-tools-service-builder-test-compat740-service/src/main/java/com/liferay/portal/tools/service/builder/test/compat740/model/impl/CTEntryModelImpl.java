...
import com.liferay.portal.tools.service.builder.test.compat740.model.CTEntryModel;
...
public class CTEntryModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table CTEntry (mvccVersion LONG default 0 not null,ctCollectionId LONG default 0 not null,ctEntryId LONG not null,companyId LONG,name VARCHAR(75) null,primary key (ctEntryId, ctCollectionId))";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("name", CTEntry::getName);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"name", (BiConsumer<CTEntry, String>)CTEntry::setName);
	...
	public CTEntry cloneWithOriginalValues() {
		...
		ctEntryImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		ctEntryImpl.setName(this.<String>getColumnOriginalValue("name"));
	...
	public CacheModel<CTEntry> toCacheModel() {
		...
		ctEntryCacheModel.name = getName();

		String name = ctEntryCacheModel.name;

		if ((name != null) && (name.length() == 0)) {
			ctEntryCacheModel.name = null;
		}
	...
	static {
		...
		columnBitmasks.put("ctEntryId", 4L);
