...
public class WarehouseChannelResourceFactoryImpl
	...
	public WarehouseChannelResource.Builder create() {
		return new WarehouseChannelResource.Builder() {
			...
			public WarehouseChannelResource build() {
				...
				Function<InvocationHandler, WarehouseChannelResource>
					warehouseChannelResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_warehouseChannelResourceProxyProviderFunction;

				return warehouseChannelResourceProxyProviderFunction.apply(
			...
			@Override
			public WarehouseChannelResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, WarehouseChannelResource>
				_warehouseChannelResourceProxyProviderFunction =
					_getProxyProviderFunction();
