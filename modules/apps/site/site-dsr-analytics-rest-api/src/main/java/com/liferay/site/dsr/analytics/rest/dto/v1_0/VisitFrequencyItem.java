 ...
 */
@Generated("")
@GraphQLName("VisitFrequencyItem")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "VisitFrequencyItem")
public class VisitFrequencyItem implements Serializable {

	public static VisitFrequencyItem toDTO(String json) {
		return ObjectMapperUtil.readValue(VisitFrequencyItem.class, json);
	}

	public static VisitFrequencyItem unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(VisitFrequencyItem.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.VisitFrequencyItem",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1738911860