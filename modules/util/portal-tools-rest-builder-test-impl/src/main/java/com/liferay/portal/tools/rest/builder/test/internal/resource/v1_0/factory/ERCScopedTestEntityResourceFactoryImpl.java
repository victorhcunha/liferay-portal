 ...
 */
@Component(
	property = "resource.locator.key=/test/v1.0/ERCScopedTestEntity",
	service = ERCScopedTestEntityResource.Factory.class
)
@Generated("")
public class ERCScopedTestEntityResourceFactoryImpl
	implements ERCScopedTestEntityResource.Factory {

	@Override
	public ERCScopedTestEntityResource.Builder create() {
		return new ERCScopedTestEntityResource.Builder() {
			...
			public ERCScopedTestEntityResource build() {
				...
				Function<InvocationHandler, ERCScopedTestEntityResource>
					ercScopedTestEntityResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_ercScopedTestEntityResourceProxyProviderFunction;

				return ercScopedTestEntityResourceProxyProviderFunction.apply(
			...
			@Override
			public ERCScopedTestEntityResource.Builder checkPermissions(
			...
			@Override
			public ERCScopedTestEntityResource.Builder httpServletRequest(
			...
			@Override
			public ERCScopedTestEntityResource.Builder httpServletResponse(
			...
			@Override
			public ERCScopedTestEntityResource.Builder preferredLocale(
			...
			@Override
			public ERCScopedTestEntityResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ERCScopedTestEntityResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ERCScopedTestEntityResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ERCScopedTestEntityResource.class.getClassLoader(),
			ERCScopedTestEntityResource.class);

		try {
			Constructor<ERCScopedTestEntityResource> constructor =
				(Constructor<ERCScopedTestEntityResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(ercScopedTestEntityResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ERCScopedTestEntityResource>
				_ercScopedTestEntityResourceProxyProviderFunction =
					_getProxyProviderFunction();
