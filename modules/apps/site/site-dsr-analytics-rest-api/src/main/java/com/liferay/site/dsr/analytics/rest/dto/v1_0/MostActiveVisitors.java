 ...
 */
@Generated("")
@GraphQLName("MostActiveVisitors")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MostActiveVisitors")
public class MostActiveVisitors implements Serializable {

	public static MostActiveVisitors toDTO(String json) {
		return ObjectMapperUtil.readValue(MostActiveVisitors.class, json);
	}

	public static MostActiveVisitors unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(MostActiveVisitors.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.MostActiveVisitors",
		name = "x-class-name"
	)
