 ...
 */
@Component(
	property = "bulk.selection.action.key=move.object",
	service = BulkSelectionAction.class
)
public class MoveBulkSelectionAction extends BaseObjectBulkSelectionAction {
	...
	protected void doExecute(
		...
		if (object instanceof ObjectEntry) {
			...
			defaultObjectEntryManager.moveObjectEntry(
