 ...
 */
@Component(
	property = "resource.locator.key=/headless-delivery/v1.0/DocumentShortcut",
	service = DocumentShortcutResource.Factory.class
)
@Generated("")
public class DocumentShortcutResourceFactoryImpl
	implements DocumentShortcutResource.Factory {

	@Override
	public DocumentShortcutResource.Builder create() {
		return new DocumentShortcutResource.Builder() {
			...
			public DocumentShortcutResource build() {
				...
				Function<InvocationHandler, DocumentShortcutResource>
					documentShortcutResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_documentShortcutResourceProxyProviderFunction;

				return documentShortcutResourceProxyProviderFunction.apply(
			...
			@Override
			public DocumentShortcutResource.Builder checkPermissions(
			...
			@Override
			public DocumentShortcutResource.Builder httpServletRequest(
			...
			@Override
			public DocumentShortcutResource.Builder httpServletResponse(
			...
			@Override
			public DocumentShortcutResource.Builder preferredLocale(
			...
			@Override
			public DocumentShortcutResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public DocumentShortcutResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, DocumentShortcutResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DocumentShortcutResource.class.getClassLoader(),
			DocumentShortcutResource.class);

		try {
			Constructor<DocumentShortcutResource> constructor =
				(Constructor<DocumentShortcutResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(documentShortcutResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, DocumentShortcutResource>
				_documentShortcutResourceProxyProviderFunction =
					_getProxyProviderFunction();
