 ...
 */
@Component(
	property = "resource.locator.key=/analytics-cms-rest/v1.0/ObjectEntryHistogramMetric",
	service = ObjectEntryHistogramMetricResource.Factory.class
)
@Generated("")
public class ObjectEntryHistogramMetricResourceFactoryImpl
	implements ObjectEntryHistogramMetricResource.Factory {

	@Override
	public ObjectEntryHistogramMetricResource.Builder create() {
		return new ObjectEntryHistogramMetricResource.Builder() {
			...
			public ObjectEntryHistogramMetricResource build() {
				...
				Function<InvocationHandler, ObjectEntryHistogramMetricResource>
					objectEntryHistogramMetricResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_objectEntryHistogramMetricResourceProxyProviderFunction;

				return objectEntryHistogramMetricResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ObjectEntryHistogramMetricResource.Builder checkPermissions(
			...
			@Override
			public ObjectEntryHistogramMetricResource.Builder
			...
			@Override
			public ObjectEntryHistogramMetricResource.Builder preferredLocale(
			...
			@Override
			public ObjectEntryHistogramMetricResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ObjectEntryHistogramMetricResource.Builder user(User user) {
				_user = user;
	...
	private static Function
		<InvocationHandler, ObjectEntryHistogramMetricResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ObjectEntryHistogramMetricResource.class.getClassLoader(),
			ObjectEntryHistogramMetricResource.class);

		try {
			Constructor<ObjectEntryHistogramMetricResource> constructor =
				(Constructor<ObjectEntryHistogramMetricResource>)
