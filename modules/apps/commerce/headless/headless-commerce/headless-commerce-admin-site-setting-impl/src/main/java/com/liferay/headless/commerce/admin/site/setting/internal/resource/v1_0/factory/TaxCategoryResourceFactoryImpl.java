	...
	public TaxCategoryResource.Builder create() {
		return new TaxCategoryResource.Builder() {
			...
			public TaxCategoryResource build() {
				...
				Function<InvocationHandler, TaxCategoryResource>
					taxCategoryResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_taxCategoryResourceProxyProviderFunction;

				return taxCategoryResourceProxyProviderFunction.apply(
...
// LIFERAY-REST-BUILDER-HASH:2105435381