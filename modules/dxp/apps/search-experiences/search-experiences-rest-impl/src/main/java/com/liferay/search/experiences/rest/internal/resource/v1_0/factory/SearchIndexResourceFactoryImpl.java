 ...
 */
@Component(
	property = "resource.locator.key=/search-experiences-rest/v1.0/SearchIndex",
	service = SearchIndexResource.Factory.class
)
@Generated("")
public class SearchIndexResourceFactoryImpl
	implements SearchIndexResource.Factory {

	@Override
	public SearchIndexResource.Builder create() {
		return new SearchIndexResource.Builder() {
			...
			public SearchIndexResource build() {
				...
				Function<InvocationHandler, SearchIndexResource>
					searchIndexResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_searchIndexResourceProxyProviderFunction;

				return searchIndexResourceProxyProviderFunction.apply(
			...
			@Override
			public SearchIndexResource.Builder checkPermissions(
			...
			@Override
			public SearchIndexResource.Builder httpServletRequest(
			...
			@Override
			public SearchIndexResource.Builder httpServletResponse(
			...
			@Override
			public SearchIndexResource.Builder preferredLocale(
			...
			@Override
			public SearchIndexResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public SearchIndexResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, SearchIndexResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SearchIndexResource.class.getClassLoader(),
			SearchIndexResource.class);

		try {
			Constructor<SearchIndexResource> constructor =
				(Constructor<SearchIndexResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(searchIndexResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, SearchIndexResource>
			_searchIndexResourceProxyProviderFunction =
				_getProxyProviderFunction();
