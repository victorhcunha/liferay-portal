 ...
 */
@Component(
	property = "resource.locator.key=/headless-admin-user/v1.0/Ticket",
	service = TicketResource.Factory.class
)
@Generated("")
public class TicketResourceFactoryImpl implements TicketResource.Factory {

	@Override
	public TicketResource.Builder create() {
		return new TicketResource.Builder() {
			...
			@Override
			public TicketResource.Builder checkPermissions(
			...
			@Override
			public TicketResource.Builder httpServletRequest(
			...
			@Override
			public TicketResource.Builder httpServletResponse(
			...
			@Override
			public TicketResource.Builder preferredLocale(
			...
			@Override
			public TicketResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public TicketResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, TicketResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			TicketResource.class.getClassLoader(), TicketResource.class);

		try {
			Constructor<TicketResource> constructor =
				(Constructor<TicketResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(ticketResource);
	...
	private ComponentServiceObjects<TicketResource> _componentServiceObjects;
