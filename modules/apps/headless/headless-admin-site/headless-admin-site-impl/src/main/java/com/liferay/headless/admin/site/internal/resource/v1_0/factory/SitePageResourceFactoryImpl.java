 ...
 */
@Component(
	property = "resource.locator.key=/headless-admin-site/v1.0/SitePage",
...
public class SitePageResourceFactoryImpl implements SitePageResource.Factory {
	...
	public SitePageResource.Builder create() {
		return new SitePageResource.Builder() {
			...
			@Override
			public SitePageResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
...
// LIFERAY-REST-BUILDER-HASH:-951202202