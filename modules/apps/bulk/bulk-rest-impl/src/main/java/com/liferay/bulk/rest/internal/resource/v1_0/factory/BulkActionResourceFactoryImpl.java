 ...
 */
@Component(
	property = "resource.locator.key=/bulk/v1.0/BulkAction",
	service = BulkActionResource.Factory.class
)
@Generated("")
public class BulkActionResourceFactoryImpl
	implements BulkActionResource.Factory {

	@Override
	public BulkActionResource.Builder create() {
		return new BulkActionResource.Builder() {
			...
			public BulkActionResource build() {
				...
				Function<InvocationHandler, BulkActionResource>
					bulkActionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_bulkActionResourceProxyProviderFunction;

				return bulkActionResourceProxyProviderFunction.apply(
			...
			@Override
			public BulkActionResource.Builder checkPermissions(
			...
			@Override
			public BulkActionResource.Builder httpServletRequest(
			...
			@Override
			public BulkActionResource.Builder httpServletResponse(
			...
			@Override
			public BulkActionResource.Builder preferredLocale(
			...
			@Override
			public BulkActionResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
			...
			@Override
			public BulkActionResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, BulkActionResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			BulkActionResource.class.getClassLoader(),
			BulkActionResource.class);

		try {
			Constructor<BulkActionResource> constructor =
				(Constructor<BulkActionResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(bulkActionResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, BulkActionResource>
			_bulkActionResourceProxyProviderFunction =
				_getProxyProviderFunction();
