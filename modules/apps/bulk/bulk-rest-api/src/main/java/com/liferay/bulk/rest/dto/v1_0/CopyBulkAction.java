 ...
 */
@Generated("")
@GraphQLName("CopyBulkAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CopyBulkAction")
public class CopyBulkAction extends BulkAction implements Serializable {

	public static CopyBulkAction toDTO(String json) {
		return ObjectMapperUtil.readValue(CopyBulkAction.class, json);
	}

	public static CopyBulkAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CopyBulkAction.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CopyBulkAction)) {
			return false;
		}

		CopyBulkAction copyBulkAction = (CopyBulkAction)object;

		return Objects.equals(toString(), copyBulkAction.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.CopyBulkAction",
		name = "x-class-name"
	)
