 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-account/v1.0/AccountChannelShippingOption",
	service = AccountChannelShippingOptionResource.Factory.class
)
@Generated("")
public class AccountChannelShippingOptionResourceFactoryImpl
	implements AccountChannelShippingOptionResource.Factory {

	@Override
	public AccountChannelShippingOptionResource.Builder create() {
		return new AccountChannelShippingOptionResource.Builder() {
			...
			@Override
			public AccountChannelShippingOptionResource.Builder
			...
			@Override
			public AccountChannelShippingOptionResource.Builder preferredLocale(
			...
			@Override
			public AccountChannelShippingOptionResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public AccountChannelShippingOptionResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AccountChannelShippingOptionResource.class.getClassLoader(),
			AccountChannelShippingOptionResource.class);

		try {
			Constructor<AccountChannelShippingOptionResource> constructor =
				(Constructor<AccountChannelShippingOptionResource>)
