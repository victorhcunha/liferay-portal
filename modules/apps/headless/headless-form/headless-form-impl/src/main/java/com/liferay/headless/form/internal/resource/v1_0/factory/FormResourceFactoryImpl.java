	...
	public FormResource.Builder create() {
		return new FormResource.Builder() {
			...
			public FormResource build() {
				...
				Function<InvocationHandler, FormResource>
					formResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_formResourceProxyProviderFunction;

				return formResourceProxyProviderFunction.apply(
