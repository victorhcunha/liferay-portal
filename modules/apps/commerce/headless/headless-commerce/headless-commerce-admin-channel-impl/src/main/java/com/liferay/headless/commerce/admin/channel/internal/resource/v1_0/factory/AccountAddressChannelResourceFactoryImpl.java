 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-channel/v1.0/AccountAddressChannel",
	service = AccountAddressChannelResource.Factory.class
)
@Generated("")
public class AccountAddressChannelResourceFactoryImpl
	implements AccountAddressChannelResource.Factory {

	@Override
	public AccountAddressChannelResource.Builder create() {
		return new AccountAddressChannelResource.Builder() {
			...
			public AccountAddressChannelResource build() {
				...
				Function<InvocationHandler, AccountAddressChannelResource>
					accountAddressChannelResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_accountAddressChannelResourceProxyProviderFunction;

				return accountAddressChannelResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountAddressChannelResource.Builder checkPermissions(
			...
			@Override
			public AccountAddressChannelResource.Builder httpServletRequest(
			...
			@Override
			public AccountAddressChannelResource.Builder httpServletResponse(
			...
			@Override
			public AccountAddressChannelResource.Builder preferredLocale(
			...
			@Override
			public AccountAddressChannelResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public AccountAddressChannelResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, AccountAddressChannelResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AccountAddressChannelResource.class.getClassLoader(),
			AccountAddressChannelResource.class);

		try {
			Constructor<AccountAddressChannelResource> constructor =
				(Constructor<AccountAddressChannelResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, AccountAddressChannelResource>
				_accountAddressChannelResourceProxyProviderFunction =
					_getProxyProviderFunction();
