 ...
 */
@Generated("")
@GraphQLName("IdentityActivity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "IdentityActivity")
public class IdentityActivity implements Serializable {

	public static IdentityActivity toDTO(String json) {
		return ObjectMapperUtil.readValue(IdentityActivity.class, json);
	}

	public static IdentityActivity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(IdentityActivity.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.IdentityActivity",
		name = "x-class-name"
	)
