 ...
 */
@Component(
	property = "resource.locator.key=/analytics-cms-rest/v1.0/ObjectEntryAcquisitionChannel",
	service = ObjectEntryAcquisitionChannelResource.Factory.class
)
@Generated("")
public class ObjectEntryAcquisitionChannelResourceFactoryImpl
	implements ObjectEntryAcquisitionChannelResource.Factory {

	@Override
	public ObjectEntryAcquisitionChannelResource.Builder create() {
		return new ObjectEntryAcquisitionChannelResource.Builder() {
			...
			public ObjectEntryAcquisitionChannelResource build() {
				...
				Function
					<InvocationHandler, ObjectEntryAcquisitionChannelResource>
						objectEntryAcquisitionChannelResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_objectEntryAcquisitionChannelResourceProxyProviderFunction;

				return objectEntryAcquisitionChannelResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ObjectEntryAcquisitionChannelResource.Builder
			...
			@Override
			public ObjectEntryAcquisitionChannelResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ObjectEntryAcquisitionChannelResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ObjectEntryAcquisitionChannelResource.class.getClassLoader(),
			ObjectEntryAcquisitionChannelResource.class);

		try {
			Constructor<ObjectEntryAcquisitionChannelResource> constructor =
				(Constructor<ObjectEntryAcquisitionChannelResource>)
	...
	private ComponentServiceObjects<ObjectEntryAcquisitionChannelResource>
