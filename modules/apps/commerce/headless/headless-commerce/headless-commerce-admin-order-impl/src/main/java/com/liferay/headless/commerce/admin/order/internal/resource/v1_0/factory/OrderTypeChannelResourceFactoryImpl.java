...
public class OrderTypeChannelResourceFactoryImpl
	...
	public OrderTypeChannelResource.Builder create() {
		return new OrderTypeChannelResource.Builder() {
			...
			public OrderTypeChannelResource build() {
				...
				Function<InvocationHandler, OrderTypeChannelResource>
					orderTypeChannelResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_orderTypeChannelResourceProxyProviderFunction;

				return orderTypeChannelResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderTypeChannelResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, OrderTypeChannelResource>
				_orderTypeChannelResourceProxyProviderFunction =
					_getProxyProviderFunction();
